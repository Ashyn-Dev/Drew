"""
Product Analysis Task - Extracts product info and retrieves configuration
"""
...
def create_analysis_task(product_analyzer_agent):
    ...
    return Task(
        ...
        expected_output="JSON with product name, current config, and specific requested updates",
    )