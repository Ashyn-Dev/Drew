"""
Crew Configuration v2 - Main crew setup and orchestration with extension support
"""
...
class ProductConfigurationCrew:
    """
    CrewAI setup for automated product configuration validation and updates v2.
    
    This crew uses two agents working sequentially:
    1. Product Analyzer - Extracts product info and gets current config including extensions
    2. Product Updater - Applies configuration updates for all fields including extension codes
    
    v2 Enhancement: Added support for extension code updates (code1, code2, code3)
    """
...
if __name__ == "__main__":
    # Initialize crew (replace with your actual API key)
    api_key = "your-openai-api-key-here"
    crew = ProductConfigurationCrew(api_key)
    
    # Run with sample input for section/subsection updates
    print("Testing section/subsection update:")
